  ...
  implements Runnable
{
  ...
  private void notifyOnReceiveMessageFromClient(Socket paramSocket, Message paramMessage)
  {
    ...
    while (true)
    {
      if (!localIterator.hasNext())
        return;
      ((PosterListener)localIterator.next()).OnReceiveMessageFromClient(paramSocket, paramMessage);
    }
  }
  ...
  {
    public abstract void OnReceiveMessageFromClient(Socket paramSocket, Message paramMessage);
  }
}

/* Location:           /home/owwlo/com.owwlo.courier.s-1.apk_FILES/classes_dex2jar.jar
 * Qualified Name:     com.owwlo.courier.s.poster.Poster
